...
public class Fonts {
    public static final String[] BUILTIN_FONTS = { "HarmonyOS Sans SC", "JetBrains Mono", "Comfortaa", "Tw Cen MT", "Pixelation" };
    ...
    public static void refresh() {
        ...
        // Use the bundled HarmonyOS Sans SC instead of Minecraft's default font.
